...
<body>
    ...
    <div class="main">
        <div class="panel-card" style="min-height: 250px">
            ...
            <div class="inner">
                <div class="separator">
                <span>credit card</span> <img src="./img/cc.png" style="width:1em; height:1em; vertical-align:middle;"><br><br>
                    
                    <select id="length">
                        <option value="1">1 month - $9.99</option>
                        <option value="3">3 month - $19.99</option>
                        <option value="2">6 month - $34.99</option>
                    </select><br>
                ...
                <div class="separator">
                <span>crypto</span> <img src="./img/crypto.png" style="width:1em; height:1em; vertical-align:middle;"><br><br>
